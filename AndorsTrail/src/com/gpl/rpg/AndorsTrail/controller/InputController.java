...
public final class InputController implements OnClickListener, OnLongClickListener {
    ...
    public void onClick(View arg0) {
        if (!world.model.uiSelections.isInCombat && controllers.preferences.noAutoConversation) {
            controllers.mapController.handleMapClick(lastTouchPosition_tileCoords);
        } else {
    ...
    public boolean onTouchedTile(int tile_x, int tile_y) {
        ...
        if (!controllers.preferences.noAutoConversation || !controllers.mapController.handleMapClick(lastTouchPosition_tileCoords)) {
